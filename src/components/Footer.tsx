        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 lg:col-span-2">
            <Link to="/" className="flex items-center space-x-2">
              <span className="text-xl font-bold text-white">TradeCraft</span>
            </Link>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link to="/about#mission" className="text-base text-gray-300 hover:text-white">
                      Our Mission
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/about#careers" className="text-base text-gray-300 hover:text-white">
                      Careers
                    </Link>
                  </li>
                </ul>
